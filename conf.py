...
# -*- coding: utf-8 -*-
#
# Python Testing documentation build configuration file, created by
# sphinx-quickstart on Fri Feb  9 20:12:10 2018.
#
...
sys.path.append(os.path.abspath(os.path.join(os.path.abspath('.'), '../scripts/')))
...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', '*.psd']
